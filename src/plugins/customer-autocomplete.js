function customer_autocomplete(inp, arr) {
       ...
       a.classList.add('autocomplete-items', 'bg-light', 'position-absolute', 'border', 'mt-1', 'w-100', 'rounded', 'shadow-sm')
    ...
    btn.innerHTML = '<button class="btn btn-outline-dark btn-block" data-toggle="modal" data-target="#add-customer-modal">+ Add customer</button>'
