  ...
  document
    ...
    e.addEventListener("input", function (e) {
      ...
      for (
        ...
        t[a].substr(0, d.length).toUpperCase() == d.toUpperCase() &&
          ((s = document.createElement("li")).classList.add(
            "list-group-item",
            "border-bottom-0"
          ),
          (s.innerHTML = t[a].substr(0, d.length)),
          (s.innerHTML += "<strong>" + t[a].substr(d.length) + "</strong>"),
          (s.innerHTML += '<input type="hidden" value="' + t[a] + '">'),
          s.addEventListener("click", function (e) {
            (app.itemName = this.getElementsByTagName("input")[0].value), o();
          }),
          i.appendChild(s));
    }),
